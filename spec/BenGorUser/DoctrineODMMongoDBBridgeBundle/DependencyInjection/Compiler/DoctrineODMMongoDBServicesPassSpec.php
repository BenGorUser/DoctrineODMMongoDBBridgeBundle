...
namespace spec\BenGorUser\DoctrineODMMongoDBBridgeBundle\DependencyInjection\Compiler;
...
/**
 * Spec file of DoctrineODMMongoDBServicesPass class.
 *
 * @author Beñat Espiña <benatespina@gmail.com>
 */
class DoctrineODMMongoDBServicesPassSpec extends ObjectBehavior
{
    function it_is_initializable()
    {
        $this->shouldHaveType(DoctrineODMMongoDBServicesPass::class);
    }
    ...
    function it_does_not_process_because_the_persistence_layer_is_not_doctrine_odm_mongodb(ContainerBuilder $container)
    {
    ...
    function it_processes_doctrine_odm_mongodb(ContainerBuilder $container, Definition $definition)
    {
        $container->getParameter('bengor_user.config')->shouldBeCalled()->willReturn([
            'user_class' => [
                'user' => [
